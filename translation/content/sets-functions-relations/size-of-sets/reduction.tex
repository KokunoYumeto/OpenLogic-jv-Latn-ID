...
$f(Z)$ dadi rerangken $s_{k}$ saengga $s_{k}(n) = 1$ yen lan mung yen $n \in Z$,
lan $s_k(n) = 0$ yen ora mangkono. Iki cetha netepake sawijining fungsi,
...
\Bin^\omega$, nanging $\PosInt$ iku !!{enumerable}.
\end{explain}
